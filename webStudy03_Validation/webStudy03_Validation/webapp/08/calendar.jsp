...
<h4> 
	<a onclick="return clickHandler(event)" href="#" data-year="<%=beforeYear%>" data-month="<%=beforeMonth%>">⬅️️️</a>
	<%=String.format("%1$tY, %1$tB", calendar) %>
	<a onclick="return clickHandler(event)" href="#" data-year="<%=nextYear%>" data-month="<%=nextMonth%>">➡️</a>
</h4>
<form name="calForm">
